...
function ready() {
  ...
  for (var i = 0; i < addToCartButtons.length; i++) {
    ...
    button.addEventListener("click", add_tocart);
  }
}
...
function update_cart_total() {
  ...
  //   console.log(test_cart_total);
  const test_add_ons_total = parseFloat(add_ons);
  //   console.log(test_add_ons_total);
...
function add_to_cart(cart_item) {
  ...
  for (var i = 0; i < checkBoxes.length; i++) {
    if (checkBoxes[i].checked) {
      ...
      //   var add_on_price = checkBoxes[i].data("price");
...
function display_products(products = "") {
  ...
  if (products !== null && products.length > 0) {
    for (i = 0; i < products.length; i++) {
      // console.log(products[i].partner_id)
      display_products +=
      ...
      // console.log($('.shop-item-partner-id'));
...
// $(document).one("click", "#add_on_btn", function (e) {
//   add_items(e);
// });
...
function add_tocart(e) {
  /** add_ons */
  //   var grid = document.getElementById("add_on_details");
  //   var checkBoxes = grid.getElementsByTagName("INPUT");
  //   var add_ons_items = [];
  //   add_ons_items =
  //     localStorage.getItem("add_ons_items") !== null
  //       ? JSON.parse(localStorage.getItem("add_ons_items"))
  //       : null;
  //   for (var i = 0; i < checkBoxes.length; i++) {
  //     if (checkBoxes[i].checked) {
  //       var row = checkBoxes[i].parentNode.parentNode;
  //       var products_id = row.cells[0].innerHTML;
  //       var add_ons_name = row.cells[1].innerHTML;
  //       var add_ons_price = row.cells[2].innerHTML;
  //       var add_ons_item = {
  //         products_id: products_id,
  //         add_ons_name: add_ons_name,
  //         add_ons_price: add_ons_price
  //       };
  //       var data = localStorage.getItem("add_ons_items");
  //       data =
  //         localStorage.getItem("add_ons_items") !== null
  //           ? JSON.parse(data)
  //           : null;
  //       add_ons_items.push(add_ons_item);
  //     }
  //   }
  //   localStorage.setItem("add_ons_items", JSON.stringify(add_ons_items));
  /** ******************************************** **/
  //   console.log(add_ons_name);
