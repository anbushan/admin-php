                    ...
                    <div class="content-area p-4">
                        <div class="card-innr">
                            ...
                            <div class="col-md-12 mt-3 mb-3 mb-5">
                                ...
                                <br>
                                <a href="" id="upload-files-btn" class="btn btn-info float-right">Upload</a>
                            </div>
...
<footer class="main-footer text-right">
    <strong>Copyright &copy; 2023-2024 <a class="text text-info" href="<?= base_url('admin/home') ?>"><?php $settings = get_settings('system_settings', true);
