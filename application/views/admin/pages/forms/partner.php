                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 map-div">
                                                <label for="city_name">Search Partner Location</label>
                                                <input id="city-input" type="text" class="form-control" placeholder="Enter Partner Location" autocomplete="off" />
                                                </br>
                                                <span class="text text-primary">Search your partner location and you will get the location points(Latitude & Longitude) below.</span>
                                            </div>
                                            <div class="col-md-8">
                                                <div id="map"></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="latitude" min="0" step="0.000000000000000001" readonly id="city_lat" value="<?= @$fetched_data[0]['latitude'] ?>" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="longitude">Longitude <span class='text-danger text-sm'>*</span></label>
                                                    <input type="number" class="form-control" name="longitude" min="0" step="0.000000000000000001" readonly id="city_long" value="<?= @$fetched_data[0]['longitude'] ?>" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="licence_name" class="col-sm-3 col-form-label">Licence Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="licence_name" placeholder="Licence Name" name="licence_name" value="<?= (isset($fetched_data[0]['licence_name']) && !empty($fetched_data[0]['licence_name'])) ? output_escaping($fetched_data[0]['licence_name']) : "" ?>">
                                            </div>
                                            <label for="licence_code" class="col-sm-3 col-form-label">Licence Code</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="licence_code" placeholder="Licence Name" name="licence_code" value="<?= (isset($fetched_data[0]['licence_code']) && !empty($fetched_data[0]['licence_code'])) ? output_escaping($fetched_data[0]['licence_code']) : "" ?>">
                                            </div>
                                            <div class="col-sm-10">
                                                <label for="licence_proof" class="col-sm-3 col-form-label">Licence Proof</label>
                                                <?php if (isset($fetched_data[0]['licence_proof']) && !empty($fetched_data[0]['licence_proof'])) { ?>
                                                    <span class="text-danger">*Leave blank if there is no change</span>
                                                <?php } ?>
                                                <input type="file" class="form-control" multiple name="licence_proof[]" id="licence_proof" accept="image/*" />
                                            </div>
                                            <tr>
                                                <?php if (!empty($fetched_data[0]['licence_proof'])) {
                                                    $licence_proof = json_decode($fetched_data[0]['licence_proof']); ?>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-md-10">
                                                                <?php foreach ($licence_proof as $proof) {
                                                                    $file = new SplFileInfo($proof);
                                                                    $extension  = $file->getExtension();
                                                                    $image_extension = array('jpg', 'png', 'jpeg');
                                                                    if (in_array($extension, $image_extension)) { ?>
                                                                        <a href='<?= base_url($proof) ?>' data-toggle="lightbox">
                                                                            <img src=' <?= base_url($proof) ?> ' class="img-fluid rounded" height="100px" width="100px">
                                                                        </a>
                                                                    <?php } ?>
                                                                    <input type="hidden" name="old_licence_proof[]" value='<?= $proof ?>'>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                        ...
                                        <div class="form-group mt-3">
                                            <label class="col-sm-3 col-form-label">Licence Approval Status <span class='text-danger text-sm'>*</span></label>
                                            <div id="licence_status" class="btn-group btn-sm col-sm-8 mt-3">
                                                <label class="btn  btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                    <input type="radio" name="licence_status" value="1" <?= (isset($fetched_data[0]['licence_status']) && $fetched_data[0]['licence_status'] == '1') ? 'Checked' : '' ?>> Approved
                                                </label>
                                                <label class="btn btn-danger" data-toggle-class="btn-danger" data-toggle-passive-class="btn-default">
                                                    <input type="radio" name="licence_status" value="0" <?= (isset($fetched_data[0]['licence_status']) && $fetched_data[0]['licence_status'] == '0') ? 'Checked' : '' ?>> Not-Approved
                                                </label>
                                            </div>
                                        </div>
                                        </div>
