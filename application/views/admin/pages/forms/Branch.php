            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <!-- <li class="breadcrumb-item"> <a class="btn btn-xs btn-dark text-white" data-toggle="modal" data-target="#howItWorksModal" title="How it works">How city will work?</a></li> -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/branch/add_branch'); ?>" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" step="0.000000000000000001" readonly class="form-control" name="latitude" id="city_lat" value="<?= (isset($fetched_details[0]['latitude']) ? $fetched_details[0]['latitude'] : '') ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="longitude">Longitude <span class='text-danger text-sm'>*</span></label>
                                            <input type="number" min="0" step="0.000000000000000001" readonly class="form-control" name="longitude" id="city_long" value="<?= (isset($fetched_details[0]['longitude']) ? $fetched_details[0]['longitude'] : '') ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="branch_name" value="<?= @$fetched_details[0]['branch_name'] ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Description</label>
                                        <textarea type="text" class="form-control" name="description"><?= @$fetched_details[0]['description'] ?></textarea>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Address <span class='text-danger text-sm'>*</span></label>
                                        <textarea type="text" class="form-control" name="address" min="0"><?= @$fetched_details[0]['address'] ?></textarea>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Email <span class='text-danger text-sm'>*</span></label>
                                        <input type="text" class="form-control" name="email" value="<?= @$fetched_details[0]['email'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Contact <span class='text-danger text-sm'>*</span></label>
                                        <input type="text" id="numberInput" oninput="validateNumberInput(this)" class="form-control" name="contact" id="contact" value="<?= @$fetched_details[0]['contact'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4 col-sm-3">
                                            ...
                                            <div class="card-body">
                                                <input type="checkbox" name="default_mode" <?= (isset($fetched_details[0]['default_branch']) && $fetched_details[0]['default_branch'] == '1') ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4 col-sm-3">
                                            ...
                                            <div class="card-body">
                                                <input type="checkbox" name="self_pickup" <?= (isset($fetched_details[0]['self_pickup']) && $fetched_details[0]['self_pickup'] == '1') ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4 col-sm-3">
                                            <label for="self_pickup"> Enable / Disable</label>
                                            <div class="card-body">
                                                <input type="checkbox" name="deliver_orders" <?= (isset($fetched_details[0]['deliver_orders']) && $fetched_details[0]['deliver_orders'] == '1') ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-10">
                                            <div class='col-md-3'><a class="uploadFile img btn btn-info text-white btn-sm" data-input='branch_image' data-isremovable='0' data-is-multiple-uploads-allowed='0' data-toggle="modal" data-target="#media-upload-modal" value="Upload Photo"><i class='fa fa-upload'></i> Upload</a></div>
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <div class="container-fluid row image-upload-section">
                                                    <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image">
                                                        ...
                                                        <input type="hidden" name="branch_image" value='<?= $fetched_details[0]['image'] ?>'>
                                                    </div>
                                                </div>
                                            <?php
                                            } else { ?>
                                                <div class="container-fluid row image-upload-section">
                                                    <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image"></div>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-info" id="submit_btn"><?= (isset($fetched_details[0]['id'])) ? 'Update Branch' : 'Add Branch' ?></button>
                                </div>
                            </div>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBZTUg_EgaAtJHbjpUNb-3s6DSTe6ruaKo&libraries=drawing,places&v=weekly" />
</script>
<script>
