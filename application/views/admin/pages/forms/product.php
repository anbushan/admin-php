        ...
        <div class="container-fluid">
            <form class="form-horizontal" action="<?= base_url('admin/product/add_product'); ?>" method="POST" enctype="multipart/form-data" id="save-product">
                ...
                ?>
                    ...
                    <!-- <input type="hidden" name="partner_id" value="<?= (isset($product_details[0]['partner_id'])) ? $product_details[0]['partner_id'] : "" ?>"> -->
                <?php } ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <!-- <div class="form-group">
                                            <label for="cities" class="col-sm-3 col-form-label">Select Branch <span class='text-danger text-sm'>*</span></label>

                                            <div class="col-sm-12">
                                                <?php
                                                $branch_selection = (isset($product_details[0]['branch_id']) && !empty($product_details[0]['branch_id'])) ? 'disabled' : '';
                                                ?>
                                                <select <?= $branch_selection ?> name="branch[]" class="search_branch w-100" multiple onload="multiselect()">
                                                    ...
                                                    <?php foreach ($branch as $row) { ?>
                                                        <?php
                                                        $selectedBranches = explode(',', $product_details[0]['branch_id']);
