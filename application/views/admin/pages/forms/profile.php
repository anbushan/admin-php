                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <?php if ($identity_column == 'email') { ?>
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="email" placeholder="Type Password here" name="email" readonly value="<?= $users->email ?>">
                                        </div>
                                    <?php } else { ?>
                                        <label for="mobile" class="col-sm-2 col-form-label">Mobile <span class='text-danger text-xs'>*</span></label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="mobile" placeholder="Type Password here" readonly name="mobile" value="<?= $users->mobile ?>" min="0">
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="form-group row">
