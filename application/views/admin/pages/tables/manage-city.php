                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/area/add_city'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" step="0.000000000000000001" readonly class="form-control" name="latitude" id="city_lat" value="<?= (isset($fetched_data[0]['latitude']) ? $fetched_data[0]['latitude'] : '') ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="longitude">Longitude <span class='text-danger text-sm'>*</span></label>
                                            <input type="number" min="0" step="0.000000000000000001" readonly class="form-control" name="longitude" id="city_long" value="<?= (isset($fetched_data[0]['longitude']) ? $fetched_data[0]['longitude'] : '') ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="bordering_city_ids[]" id="bordering_city_ids" class="search_city form-control" multiple onload="multiselect()">

                                    </select>

                                </div>
                                <div class="form-group">
                                    <label for="delivery_charge_method">Delivery Charge Methods <span class='text-danger text-sm'>*</span></label>
                                ...
                                <table class='table-striped' data-toggle="table" data-url="<?= base_url('admin/area/view_city') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="DESC" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="queryParams">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="bordering_city_ids" data-sortable="false" data-visible="true">Bordering City Ids</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            <ol>
                                ...
                                <li>Maximum Delivarable Distance [KM] : Here you have to set Maximum Delivarable for order that Distance from user to restaurant. </li>
                                <li>Related Deliverable Cities: Hre you have to set related city which are nearby city.This city you can add befire main city. </li>
                                <li>For example, If you want to add <strong>Bhuj City</strong> and their nearest cities are <strong>Mundra, mandvi etc.</strong> So you ahve to add that nearby cities first.</li>
                                <li>After adding that nearest cities then you can add Bhuj city. Here you can select that all nearest cities which you have added for bhuj city.</li>
                                <li>By adding this <strong> Related Deliverable Cities</strong> All partners which are in these cities, they al will list in application.</li>
                            </ol>
                        </div>
                    </div>
                </div>
