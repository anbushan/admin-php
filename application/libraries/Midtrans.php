...
class Midtrans
{
    ...
    public function create_transaction($order_id, $amount)
    {
        ...
        // $final_data['callbacks']['finish'] = base_url("app/v1/api/get_midtrans_transaction_status");
        $final_data['callbacks']['finish'] = base_url("app/v1/api/midtrans_payment_process");
