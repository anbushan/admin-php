...
class Orders extends CI_Controller
{
    ...
    public function view_pending_orders()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_rider()) {
            ...
            // $test = $this->Order_model->get_orders_list($deliveryBoyId, true, $city_id[0]['serviceable_city']);
            print_r($test);
    ...
    public function update_order_status()
    {
        ...
        // print_r($this->ion_auth->is_rider());
        // return false;
        // if ($this->ion_auth->logged_in() && $this->ion_auth->is_rider()) {
                ...
                if ($field == 'status') {
                    ...
                    if ($priority_status[$val] > $priority_status[$current_orders_status]) {
                        ...
                        if ($error == false) {
                            ...
                            $body =  ' Order status updated to ' . $val . ' for your order ID #' . $main_order_id . ' please take note of it! Thank you for ordering with us.';
